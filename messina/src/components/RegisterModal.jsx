...
const RegisterModal = ({ onClose, onGoLogin }) => {
  ...
  const validarCampo = (nombreCampo, valor) => {
    ...
    switch (nombreCampo) {
      case "nombre":
      case "apellido":
        if (!regexNombre.test(valor)) mensaje = "Debe tener al menos 3 letras y solo letras.";
        break;
      case "email":
      ...
      case "password":
        if (!regexPassword.test(valor))
          mensaje = "Debe tener 8 caracteres, mayúscula, número y símbolo.";
        break;
  ...
  const handleSubmit = async (e) => {
    ...
    if (hayErrores) return alert("Corrige los errores antes de continuar.");
    ...
    <div className="modal-overlay">
      <div className="modal-container">
        ...
        <form className="form" onSubmit={handleSubmit}>
          ...
          <button type="button" className="login-button" onClick={onGoLogin}>
            Ya tengo cuenta
          </button>
